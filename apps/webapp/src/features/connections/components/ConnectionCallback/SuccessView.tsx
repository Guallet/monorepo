      ...
      <Stack>
        <Group gap="md" align="flex-start">
          ...
          <Box style={{ flex: 1 }}>
            <Title order={4} mb={4}>
              {t(
                'screens.connections.callback.success.title',
                'Accounts found!',
              )}
            </Title>
            <Text size="sm" c="dimmed">
              {t(
                'screens.connections.callback.success.subtitle',
                'Found {{count}} accounts. Choose which to import.',
        ...
        <Text size="sm" c="dimmed" ta="center">
          {t(
            'screens.connections.callback.success.selectedCount',
            '{{selected}} of {{total}} accounts selected',
            {
        ...
        <Stack gap="xs">
          ...
          >
            {selectedCount > 0
              ? t(
                  'screens.connections.callback.success.import',
                  'Import {{count}} account',
                  {
                    count: selectedCount,
              ...
              : t(
                  'screens.connections.callback.success.importNone',
