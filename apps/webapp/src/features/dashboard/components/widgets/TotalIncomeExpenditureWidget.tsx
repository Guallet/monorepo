...
import { Loader, Stack, Text, Group, Box, useMantineTheme, Center, RingProgress } from "@mantine/core";
...
export function TotalIncomeExpenditureWidget({ 
  ...
  const expenditure = Math.abs(transactions
    .filter(t => t.amount < 0)
    .reduce((sum, t) => sum + t.amount, 0));
          ...
          <Center>
            <RingProgress
              ...
              sections={[
                ...
                { value: 100 - incomePercent, color: 'red', tooltip: 'Expenditure' },
              ]}
              label={
                <Center>
