export function parseNumber(value: string | number | boolean | null | undefined): number {
...
export function isValidNumber(value: string | number | boolean | null | undefined): boolean {
