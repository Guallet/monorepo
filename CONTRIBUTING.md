...
- **Code formatting:** Use [Oxfmt](https://oxc.rs/docs/guide/usage/formatter) and [Oxlint](https://oxc.rs/docs/guide/usage/linter) to format and lint your code. Run `pnpm run lint` and `pnpm run format` before submitting.
